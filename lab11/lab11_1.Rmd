...
homerange%>%
  ...
  geom_histogram(fill="tomato", color = "black", alpha=.5)
```
...
homerange%>%
  ggplot(aes(x=log10.hra))+
  geom_density(fill="tomato", color = "black", alpha=.5)
```
...
homerange%>%
  ggplot(aes(x=log10.hra))+
  geom_histogram(aes(y=..density..), fill="tomato", color = "black", alpha=.5)+
...
homerange%>%
  ...
  ggplot(aes(x=class, y=log10.hra, fill=class))+ 
  geom_boxplot()
```
